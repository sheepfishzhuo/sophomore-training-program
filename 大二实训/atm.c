...
void my_window_menu_init(void)
{
	...
	gtk_table_attach_defaults(GTK_TABLE(table),button_zc,0,2,2,3);
	GtkWidget* button_dl = gtk_button_new_with_label("老户-登录");
	gtk_table_attach_defaults(GTK_TABLE(table),button_dl,3,5,2,3);
...
void my_window_user_menu_init(void)
{
	...
	//创建其他的控件、放入布局中
	GtkWidget*label_title = gtk_label_new("欢迎来到大江银行菜单");
	gtk_label_set_markup(GTK_LABEL(label_title),"<span foreground='red' underline='double' underline_color='blue' font_desc='32'>欢迎来到大江银行菜单</span>");
	//								给谁设置（label）。         字体颜色。   双下划线             下划线颜色。        字体大小。        文本内容
	gtk_table_attach_defaults(GTK_TABLE(table),label_title,0,5,0,1);
	GtkWidget* button_zx = gtk_button_new_with_label("注销");
	gtk_table_attach_defaults(GTK_TABLE(table),button_zx,1,2,1,2);
	GtkWidget* button_zz = gtk_button_new_with_label("转账");
	gtk_table_attach_defaults(GTK_TABLE(table),button_zz,3,4,1,2);
	GtkWidget* button_ck = gtk_button_new_with_label("存款");
	gtk_table_attach_defaults(GTK_TABLE(table),button_ck,1,2,2,3);
	GtkWidget* button_qk = gtk_button_new_with_label("取款");
	gtk_table_attach_defaults(GTK_TABLE(table),button_qk,3,4,2,3);
	GtkWidget* button_cx = gtk_button_new_with_label("查询");
	gtk_table_attach_defaults(GTK_TABLE(table),button_cx,1,2,3,4);
	GtkWidget* button_dk = gtk_button_new_with_label("贷款");
	gtk_table_attach_defaults(GTK_TABLE(table),button_dk,3,4,3,4);
	GtkWidget* button_xgxx = gtk_button_new_with_label("修改信息");
	gtk_table_attach_defaults(GTK_TABLE(table),button_xgxx,1,2,4,5);
	GtkWidget* button_fh = gtk_button_new_with_label("返回");
...
void my_window_user_cx_init(void)
{
	...
	//创建其他的控件、放入布局中
	GtkWidget*label_title = gtk_label_new("欢迎来到大江银行查询界面");
	gtk_label_set_markup(GTK_LABEL(label_title),"<span foreground='red' underline='double' underline_color='blue' font_desc='32'>欢迎来到大江银行查询界面</span>");
	//								给谁设置（label）。         字体颜色。   双下划线             下划线颜色。        字体大小。        文本内容
	gtk_table_attach_defaults(GTK_TABLE(table),label_title,0,3,0,1);
...
void my_window_user_ck_init(void)
{
	...
	//创建其他的控件、放入布局中
	GtkWidget*label_title = gtk_label_new("欢迎来到大江银行存款");
	gtk_label_set_markup(GTK_LABEL(label_title),"<span foreground='red' underline='double' underline_color='blue' font_desc='32'>欢迎来到大江银行存款</span>");
	//								给谁设置（label）。         字体颜色。   双下划线             下划线颜色。        字体大小。        文本内容
	gtk_table_attach_defaults(GTK_TABLE(table),label_title,0,3,0,1);
	GtkWidget* label = gtk_label_new("存储金额：");
	gtk_label_set_markup(GTK_LABEL(label),"<span foreground='red'  font_desc='28'>存储金额：</span>");
	//								给谁设置（label）。         字体颜色。   双下划线             下划线颜色。        字体大小。        文本内容
